"""Slash command registry for LeAgent coding sessions."""
...
from le_agent_coding.provider_catalog import BUILTIN_PROVIDER_CATALOG, builtin_provider_entry
from le_agent_coding.reload import CodingReloadSummary, ReloadCategorySummary
from le_agent_coding.resources import ResourceDiagnostic
...
from le_agent_coding.thinking import normalize_thinking_level
...
def _theme_command(context: CommandContext) -> CommandResult:
    ...
    # Imported lazily so importing this module never pulls in `le_agent_coding.tui`
    # (whose package __init__ imports Textual) until /theme actually executes.
    from le_agent_coding.tui.themes import available_tui_theme_names
