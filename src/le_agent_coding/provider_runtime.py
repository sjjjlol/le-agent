"""Runtime provider construction for LeAgent coding sessions."""
...
from le_agent_ai.env import RuntimeProviderAuth
...
from le_agent_coding.oauth import (
...
from le_agent_coding.oauth_types import OAuthProvider
...
class ClosableModelProvider(ModelProvider, Protocol):
    """Runtime provider object LeAgent owns and can close."""
