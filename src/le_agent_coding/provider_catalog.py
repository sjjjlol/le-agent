"""Built-in provider catalog for LeAgent login/setup flows."""
...
class ProviderCatalogEntry:
    """A built-in provider LeAgent can present during login."""
...
def _load_builtin_catalog() -> tuple[ProviderCatalogEntry, ...]:
    ...
    from le_agent_coding.catalog_loader import builtin_catalog
