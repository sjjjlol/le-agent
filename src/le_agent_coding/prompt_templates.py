...
def load_prompt_templates(paths: LeAgentResourcePaths | None = None) -> list[PromptTemplate]:
    """Load markdown prompt templates from LeAgent and `.agents` resource directories."""
