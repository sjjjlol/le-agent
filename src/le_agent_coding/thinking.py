"""Thinking-mode primitives for LeAgent coding sessions."""
...
def normalize_thinking_level(value: str | None) -> ThinkingLevel:
    """Return a valid LeAgent thinking level or raise a user-facing error."""
    if value is None:
...
def reasoning_effort_for_level(level: str | None) -> ReasoningEffort:
    """Map LeAgent's UI thinking level to an OpenAI-compatible reasoning effort."""
