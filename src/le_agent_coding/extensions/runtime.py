...
from le_agent.events import AgentEvent, AgentStartEvent
...
from le_agent.messages import AgentMessage, TextContent
...
class ExtensionRuntime:
    ...
    def reset_for_reload(self) -> None:
        ...
        parity): any `le-agent` API object, context, or ui facade captured before
