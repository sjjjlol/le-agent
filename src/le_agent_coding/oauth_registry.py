...
from le_agent_coding.oauth import OpenAICodexOAuthProvider
from le_agent_coding.oauth_github_copilot import GitHubCopilotOAuthProvider
from le_agent_coding.oauth_types import OAuthProvider

_BUILTIN_PROVIDERS: tuple[OAuthProvider, ...] = (
...
def oauth_provider_ids() -> frozenset[str]:
    """Return IDs accepted by LeAgent's subscription login flow."""
