"""Best-effort terminal attention notifications for completed LeAgent turns."""
...
from le_agent_coding.tui.config import TurnNotificationMode
from le_agent_coding.tui.terminal_title import sanitize_terminal_title

OSC_TERMINATOR = "\a"
TURN_FINISHED_MESSAGE = "LeAgent turn finished"
...
def terminal_notification_supported(
    *,
    ...
    """Return whether LeAgent may write attention sequences to this terminal."""
