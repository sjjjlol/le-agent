...
from le_agent_coding.oauth import OAuthError, oauth_credential_is_expired
from le_agent_coding.oauth_device import DevicePollResult, poll_oauth_device_code
from le_agent_coding.oauth_github_copilot import (
...
from le_agent_coding.oauth_registry import (
    get_oauth_provider,
    oauth_provider_ids,
...
from le_agent_coding.provider_config import provider_config_from_catalog_entry
from le_agent_coding.provider_runtime import OAuthRuntimeCredentialResolver, _refresh_lock
...
def test_builtin_oauth_registry_matches_supported_subscription_providers() -> None:
    assert oauth_provider_ids() == {"github-copilot", "openai-codex"}
    assert get_oauth_provider("anthropic") is None
