...
from le_agent import ImageContent
...
from le_agent_coding.image_processing import DEFAULT_MAX_SOURCE_IMAGE_BYTES
...
async def test_create_coding_tools_returns_initial_tool_set(tmp_path: Path) -> None:
    ...
    assert [tool.name for tool in tools] == ["read", "write", "edit", "bash", "web_search"]
