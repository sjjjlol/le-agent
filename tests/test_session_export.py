...
from le_agent_coding.session_export import export_session_html, render_session_html
...
def test_render_session_html_uses_static_document_layout() -> None:
    ...
    assert '<p class="eyebrow">LeAgent session export</p>' in html
...
def test_render_session_html_includes_jsonl_download() -> None:
    ...
    html = render_session_html(
        entries, title="Download Export", source="/home/user/.le-agent/sessions/abc123.jsonl"
    )
